...
namespace GlobalSnowEffect {
    ...
    public partial class GlobalSnowProfile : ScriptableObject {
        ...
        public static void Lerp(GlobalSnow gs, GlobalSnowProfile profile1, GlobalSnowProfile profile2, float t) {
            ...
            bool requiresMaterialRefresh = false;
            ...
            Texture2D newNormals = t < 0.5f ? profile1.snowNormalsTex : profile2.snowNormalsTex;
            if (gs.snowNormalsTex != newNormals) {
                gs.snowNormalsTex = newNormals;
                requiresMaterialRefresh = true;
            }
