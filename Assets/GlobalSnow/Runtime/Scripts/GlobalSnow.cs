...
namespace GlobalSnowEffect {
    ...
    public partial class GlobalSnow : MonoBehaviour {
        ...
        void LoadResources() {
            ...
            UniversalRenderPipelineRuntimeShaders customResources = GraphicsSettings.GetRenderPipelineSettings<UniversalRenderPipelineRuntimeShaders>();
        ...
        public void UpdateMaterialPropertiesNow() {
            ...
            if (_footprints && Application.isPlaying) {
                if (characterController == null) {
                    characterController = Misc.FindObjectOfType<CharacterController>();
                }
